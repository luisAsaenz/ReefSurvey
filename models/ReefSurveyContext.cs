...
namespace ReefSurvey
{
	public partial class ReefSurveyContext : DbContext
	{
		...
		public virtual DbSet<Batches> Batches
		{
			get; set;
		}
		public virtual DbSet<Families> Families
		{
			get; set;
		}
		public virtual DbSet<Genera> Genera
		{
			get; set;
		}
		public virtual DbSet<Managements> Managements
		{
			get; set;
		}
		public virtual DbSet<Regions> Regions
		{
			get; set;
		}
		public virtual DbSet<Species> Species
		{
			get; set;
		}
		public virtual DbSet<Structures> Structures
		{
			get; set;
		}
		public virtual DbSet<StudyAreas> StudyAreas
		{
			get; set;
		}
		public virtual DbSet<SubRegions> SubRegions
		{
			get; set;
		}
		public virtual DbSet<Surveys> Surveys
		{
			get; set;
		}
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Genera>(entity =>
			{
				...
				entity.Property(e => e.GenusId).ValueGeneratedOnAdd();
				...
				entity.HasOne(d => d.Genus)
					.WithOne(p => p.Genera)
					.HasForeignKey<Genera>(d => d.GenusId)
			...
			{
				entity.Property(e => e.SpeciesId).ValueGeneratedOnAdd();
			...
			modelBuilder.Entity<StudyAreas>(entity =>
			{
				...
				entity.Property(e => e.StudyAreaId).ValueGeneratedOnAdd();
				...
				entity.HasOne(d => d.StudyArea)
					.WithOne(p => p.StudyAreas)
					.HasForeignKey<StudyAreas>(d => d.StudyAreaId)
					.OnDelete(DeleteBehavior.ClientSetNull)
			...
			modelBuilder.Entity<SubRegions>(entity =>
			{
				...
				entity.Property(e => e.SubRegionId).ValueGeneratedOnAdd();
				...
				entity.HasOne(d => d.SubRegion)
					.WithOne(p => p.SubRegions)
					.HasForeignKey<SubRegions>(d => d.SubRegionId)
					.OnDelete(DeleteBehavior.ClientSetNull)
